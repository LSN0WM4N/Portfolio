import { 
  ...
  SiExpress,
	SiCss,
	SiHtml5, } from '@icons-pack/react-simple-icons';
import { SVGProps } from 'react';

export function Javascript(props: SVGProps<SVGSVGElement>) {
	return <SiJavascript color="#F7DF1E" {...props} />
}

export function Typescript(props: SVGProps<SVGSVGElement>) {
	return <SiTypescript color="#3178C6" {...props}/> 
}

export function Go(props: SVGProps<SVGSVGElement>) {
	return <SiGo color="#00ADD8" {...props}/>
}

export function Python(props: SVGProps<SVGSVGElement>) {
	return <SiPython color="#3776AB" {...props}/>
}

export function C(props: SVGProps<SVGSVGElement>) {
  return <SiC color="#A8B9CC" {...props} />;
}

export function CPlusPlus(props: SVGProps<SVGSVGElement>) {
  return <SiCplusplus color="#00599C" {...props} />;
}
...
export function SQL(props: SVGProps<SVGSVGElement>) {
	return (
		<svg fill='#00bcf2' viewBox="-8.78 0 70 70" {...props} >
